...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('aaa', '') is True
        assert contains('aaa', 'a') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('aaa','ab') is False
        assert contains('aaa','b') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('bananas', 'anas') is True  # overlapping prefix
        assert contains('bananas', 'ana') is True
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('memo', 'mo') == 2
        assert find_index('memo', 'm') == 0
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('racecar', 'races') is None
        assert find_index('racecar', 'racer') is None
        assert find_index('racecar', 'react') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        assert find_index('alakazam', 'ala') == 0
        assert find_index('alakazam', 'aza') == 4
        assert find_index('alakazam', 'am') == 6 
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('charm', 'ha') == [1]
        assert find_all_indexes('charm', 'cha') == [0]
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('slip', 'lipz') == []
        assert find_all_indexes('slip', 'slit') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        assert find_all_indexes('dichotomy', 'hot') == [3]
        assert find_all_indexes('dichotomy', 'di') == [0] 
        assert find_all_indexes('activate', 'a') == [0, 5]  
